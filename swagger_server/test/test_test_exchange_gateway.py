...
class TestTestExchangeGateway(BaseTestCase):
    ...
    def test_getExecutions_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
            exes = gwy.getExecutions('accountId_example', 'TestInst1')
        self.assertEqual(cm.exception.msg, 'Not connected')
    ...
    def test_getOrders_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
            ords = gwy.getOrders('accountId_example')
        self.assertEqual(cm.exception.msg, 'Not connected')
    ...
    def test_getHistoricalOrders_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
    ...
    def test_cancelOrder_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
    ...
    def test_getOrder_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
            order = gwy.getOrder('accountId_example', '123')
        self.assertEqual(cm.exception.msg, 'Not connected')
    ...
    def test_modifyOrder_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
    ...
    def test_createOrder_NotConnected(self):
        gwy = TestGwy()
        with self.assertRaises(InvalidSessionError) as cm:
    ...
    def test_validateOrder_NotConnected(self):
        gwy = TestGwy()
        order = {}
        order['id'] = '1'
        order['instrument'] = 'TestInst1'
