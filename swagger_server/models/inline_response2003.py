...
from swagger_server.models.account_state_response import AccountStateResponse  # noqa: F401,E501
...
class InlineResponse2003(Model):
    ...
    def __init__(self, s: Status=None, errmsg: str=None, d: AccountStateResponse=None):  # noqa: E501
        ...
        :type d: AccountStateResponse
        """
        self.swagger_types = {
            's': Status,
            'errmsg': str,
            'd': AccountStateResponse
        }
    ...
    @property
    def d(self) -> AccountStateResponse:
    ...
    @d.setter
    def d(self, d: AccountStateResponse):
